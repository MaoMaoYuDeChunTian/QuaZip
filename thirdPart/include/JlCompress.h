...
public:
	...
	// 以某种格式压缩文件 [9/16/2019 -ZhaoY]
	static bool compressDirExtend(QString fileCompressed, QString dir, QTextCodec* Codec);
	// 以某种格式解压缩文件 [9/16/2019 -ZhaoY]
	static QStringList extractDirExtend(QString fileCompressed, QString dir, QTextCodec* Codec);
